...
I steal the function `process_gridworld_data` from
data.py of https://github.com/duguyue100/tensorflow-value-iteration-networks
...
def process_gridworld_data(data_in, imsize):
    ...
    Note the output is in tensorflow dimension
